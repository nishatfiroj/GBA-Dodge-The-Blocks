...
void updatePlayer() {
 ...
 } else if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<4))) && player.col + player.width <= 240 - 1) {
  player.col += player.cdel;
 } else if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<7))) && player.row + player.height <= 160 - 1) {
  player.row += player.cdel;
 } else if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<6))) && player.row >= 0) {
  player.row -= player.cdel;
 }
}
...
void drawPlayer() {
 ...
 drawRect(player.oldRow, player.oldCol, player.height, player.width, ((3) | (7)<<5 | (10)<<10));
...
void drawBall(BALL* b) {
 ...
 if(b->active) {
  drawRect(b->oldRow, b->oldCol, b->height, b->width, ((3) | (7)<<5 | (10)<<10));
