...
void goToPause() {
    fillScreen(((25) | (28)<<5 | (31)<<10));
    drawString(80, 100, "PAUSE", ((31) | (31)<<5 | (31)<<10));
    state = PAUSE;
}
...
void goToWin() {
    fillScreen(((29) | (30)<<5 | (31)<<10));
    drawString(80, 100, "YOU WIN!", ((25) | (28)<<5 | (31)<<10));
    state = WIN;
}
...
void goToLose() {
    fillScreen(((31) | (12)<<5 | (13)<<10));
    drawString(80, 100, "YOU LOSE!", ((31) | (31)<<5 | (31)<<10));
    state = LOSE;
}
